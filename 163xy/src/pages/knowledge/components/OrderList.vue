<template>
  <div class="order-page">
    <div class="show-orders">
      <img
        class="main-img"
        src="https://yanxuan.nosdn.127.net/0d2b1667aec92cb6b552e4316b602ca3.jpg"
        alt="mainImg"
      >
      <div class="order-top">
