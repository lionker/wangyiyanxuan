<template>
  <section class="person-container">
    <HeaderSlot>
      <span class="title-logo" slot="headerTitle"></span>
    </HeaderSlot>
    <div class="person-main" v-show="isShow">
      <div class="main-logo">
      ...
      <div class="login-methods">
        <div
          ...
          @click="gotoLogin('/person/login', true)"
        >
        ...
        <div
          class="email-login"
          :class="{active: !isActive}"
          @click="gotoLogin('/person/login', false)"
        >
          <i class="iconfont icon-email"></i>
          <span>邮箱账号登录</span>
        </div>
        <div class="quick-login" @click="gotoRegis('/person/register', true)">
          <span>手机号快捷注册</span>
