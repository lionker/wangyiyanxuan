  ...
  <section class="register-container">
    ...
    <div class="toash-info">
      ...
      <div class="text">
        ...
        <span>和</span>
        <a href="iavascript:ouvoid(0);">《网易隐私政策》</a>
      </div>
    </div>
    <div class="email-register" @click="$router.replace('/person')">
      <span>已经有账户</span>
      <i class="iconfont icon-52"></i>
    </div>
    <div
      class="email-register"
      @click="$router.replace({path: '/person/register', query: {isPhoneRegis: false}})"
